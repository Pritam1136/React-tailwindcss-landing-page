        ...
        <div className="container mx-auto px-5 py-24">
          <div className="mb-12 flex w-full flex-col text-center">
            ...
            <p className="mx-auto text-base leading-relaxed lg:w-2/3">
              If you want to work with me you can contact me directly through
              this form. Fill you detail correctly.
            </p>
          </div>
            ...
            <div className="-m-2 flex flex-wrap">
              ...
              <div className="mt-8 w-full border-t border-gray-200 p-2 pt-8 text-center">
                ...
                <span className="inline-flex">
                  ...
                  <a className="ml-4 text-gray-500" href="www.twitter.com">
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  <a className="ml-4 text-gray-500" href="www.instagram.com">
                    <svg
                      fill="none"
                      stroke="currentColor"
                      strokeLinecap="round"
                  ...
                  <a className="ml-4 text-gray-500" href="www.youtube.com">
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
